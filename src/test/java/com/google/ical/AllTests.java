...
public class AllTests extends TestSuite {
  ...
  public AllTests() {
    ...
    this.addTestSuite(com.google.ical.compat.jodatime.DateTimeIteratorFactoryTest.class);
    this.addTestSuite(com.google.ical.compat.jodatime.LocalDateIteratorFactoryTest.class);
    this.addTestSuite(com.google.ical.compat.jodatime.TimeZoneConverterTest.class);

    this.addTestSuite(com.google.ical.compat.javatime.ZonedDateTimeIteratorFactoryTest.class);
    this.addTestSuite(com.google.ical.compat.javatime.JavaLocalDateIteratorFactoryTest.class);
